...
class VLNExtendedEpisode(VLNEpisode):
    ...
    sub_instruction: Optional[List[str]] = attr.ib(default=None)
    sub_instruction_tokens: Optional[List[List[int]]] = attr.ib(default=None)
    trajectory_id: Optional[Union[int, str]] = attr.ib(default=None)
    keynodes: Optional[List[tuple]] = attr.ib(default=None)
    action_to_sub: Optional[List[int]] = attr.ib(default=None)
