...
# -----------------------------------------------------------------------------
# # VLN TASK SUB INSTRUCTION SENSOR
# -----------------------------------------------------------------------------
_C.TASK.SUB_INSTRUCTION_SENSOR = CN()
_C.TASK.SUB_INSTRUCTION_SENSOR.TYPE = "SubInstructionSensor"
_C.TASK.SUB_INSTRUCTION_SENSOR_UUID = "sub_instruction"
# -----------------------------------------------------------------------------
# # ALIGH ACTION TO SUB INSTRUCTIONS
# -----------------------------------------------------------------------------
_C.TASK.ACTION_TO_SUB_SENSOR = CN()
_C.TASK.ACTION_TO_SUB_SENSOR.TYPE = "ActionToSubSensor"
_C.TASK.ACTION_TO_SUB_SENSOR_UUID = "action_to_sub"
